<template>
  <div class="container passWord">
    ...
    <button class="sub_passWord btn" flex="main:center cross:center" v-if="isSubmit == false">确定</button>
    <button class="sub_passWord" flex="main:center cross:center" @click="submit()" v-else>确定</button>
  </div>
</template>
<script>
